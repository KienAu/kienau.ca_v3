...
const onToggleLink = (e) => {
  if (isTablet.value) {
    if (
      document.querySelector(".navigation__list").dataset.prevValue ===
    ...
    <div class="header__wrapper">
      <div class="header__logo">
        <NuxtLink class="header__link" to="/">
          <img
            class="header__logo__image header__logo__image--is-dark"
            src="../assets/icons/logo.svg"
          />
          <img
            class="header__logo__image header__logo__image--is-light"
        ...
        <ul class="navigation__list" data-prev-value="">
          ...
          >
            <NuxtLink
              ...
              @click="onToggleLink"
            >
              <span class="navigation__transition-text"></span
              ><span class="navigation__text">{{ blok.link.story.name }}</span
              ><span class="navigation__highlight"></span>
            </NuxtLink>
          </li>
        </ul>
      </nav>
