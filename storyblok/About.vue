      ...
      <div class="column--is-w6 column--is-md-w10 column--is-sm-w12">
        <section class="about__sections" v-for="section in blok.sections">
          <div
            ...
            v-if="section.component === 'Section Info'"
          >
            <span class="about__highlight-text">{{
              section.highlight_text
            }}</span>
            <p class="about__text">{{ section.text }}</p>
          </div>
          <div
            class="about__section about__section--is-list"
            v-else-if="section.component === 'Section List'"
          >
            <span class="about__highlight-text">{{
              section.highlight_text
            }}</span>
          ...
          <div
            class="about__section about__section--is-step"
            v-else-if="section.component === 'Section Step'"
          >
            <span class="about__highlight-text">{{
              section.highlight_text
            }}</span>
            ...
            <ul class="about__list">
              <li class="about__item" v-for="(item, index) in section.list">
                <span class="about__index"> {{ index + 1 }}.</span
                ><span class="about__item-text">{{ item.text }}</span>
              </li>
            </ul>
          </div>
